...
class Localize:
    ...
    def set_localized_strings(self):
        ...
        source = unicode(open(xbmc.translatePath("special://xbmc/language/English/strings.po").decode("UTF-8"), "r").read(), "UTF-8")
        # parse strings
        strings = re.findall("msgctxt.+?\"\#([^\"]+?)\"\nmsgid.+?\"([^\"]+?)\"", source)
        # create dictionary
        self.localize_text = dict([[value, xbmc.getLocalizedString(int(key))] for key, value in strings if (int(key) in LOCALIZED_STRINGS)])
        # handle specialized strings, these are [<abbreviations>, <fulltext>] lists
        ...
        self.localize_text_special.update({
            ...
            "NNE": (xbmc.getLocalizedString(72), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(88), ordinal=xbmc.getLocalizedString(89),)),
            "NE": (xbmc.getLocalizedString(73), xbmc.getLocalizedString(89)),
            "ENE": (xbmc.getLocalizedString(74), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(90), ordinal=xbmc.getLocalizedString(89),)),
            "E": (xbmc.getLocalizedString(75), xbmc.getLocalizedString(90)),
            "ESE": (xbmc.getLocalizedString(76), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(90), ordinal=xbmc.getLocalizedString(91),)),
            "SE": (xbmc.getLocalizedString(77), xbmc.getLocalizedString(91)),
            "SSE": (xbmc.getLocalizedString(78), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(92), ordinal=xbmc.getLocalizedString(91),)),
            "S": (xbmc.getLocalizedString(79), xbmc.getLocalizedString(92),),
            "SSW": (xbmc.getLocalizedString(80), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(92), ordinal=xbmc.getLocalizedString(93),)),
            "SW": (xbmc.getLocalizedString(81), xbmc.getLocalizedString(93)),
            "WSW": (xbmc.getLocalizedString(82), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(94), ordinal=xbmc.getLocalizedString(93),)),
            "W": (xbmc.getLocalizedString(83), xbmc.getLocalizedString(94),),
            "WNW": (xbmc.getLocalizedString(84), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(94), ordinal=xbmc.getLocalizedString(95),)),
            "NW": (xbmc.getLocalizedString(85), xbmc.getLocalizedString(95),),
            "NNW": (xbmc.getLocalizedString(86), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(88), ordinal=xbmc.getLocalizedString(95),)),
            "VAR": (xbmc.getLocalizedString(96), xbmc.getLocalizedString(96)),
            "North": (xbmc.getLocalizedString(71), xbmc.getLocalizedString(88),),
            "North Northeast": (xbmc.getLocalizedString(72), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(88), ordinal=xbmc.getLocalizedString(89),)),
            "Northeast": (xbmc.getLocalizedString(73), xbmc.getLocalizedString(89)),
            "East Northeast": (xbmc.getLocalizedString(74), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(90), ordinal=xbmc.getLocalizedString(89),)),
            "East": (xbmc.getLocalizedString(75), xbmc.getLocalizedString(90)),
            "East Southeast": (xbmc.getLocalizedString(76), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(90), ordinal=xbmc.getLocalizedString(91),)),
            "Southeast": (xbmc.getLocalizedString(77), xbmc.getLocalizedString(91)),
            "South Southeast": (xbmc.getLocalizedString(78), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(92), ordinal=xbmc.getLocalizedString(91),)),
            "South": (xbmc.getLocalizedString(79), xbmc.getLocalizedString(92),),
            "South Southwest": (xbmc.getLocalizedString(80), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(92), ordinal=xbmc.getLocalizedString(93),)),
            "Southwest": (xbmc.getLocalizedString(81), xbmc.getLocalizedString(93)),
            "West Southwest": (xbmc.getLocalizedString(82), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(94), ordinal=xbmc.getLocalizedString(93),)),
            "West": (xbmc.getLocalizedString(83), xbmc.getLocalizedString(94),),
            "West Northwest": (xbmc.getLocalizedString(84), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(94), ordinal=xbmc.getLocalizedString(95),)),
            "Northwest": (xbmc.getLocalizedString(85), xbmc.getLocalizedString(95),),
            "North Northwest": (xbmc.getLocalizedString(86), "{cardinal} {ordinal}".format(cardinal=xbmc.getLocalizedString(88), ordinal=xbmc.getLocalizedString(95),)),
    ...
    def localize_unit(self, value, unit="temp", **kwargs):
        ...
        # wind conversion
            ...
            # if speed isn't a valid integer, we localize the text (e.g. calm)
            if (value.isdigit()):
            ...
            try:
                ...
                # must be text, localize and return (e.g. calm)
            ...
            # distance conversion
                ...
                distanceunit = [33047, 33045][xbmc.getRegion(id="speedunit") == "mph"]
                # calculate the localized distance
                if (distanceunit == 33047):
    ...
    def translate_text(self, phrases, language="en"):
        ...
        # set language params
        params = ({
            "langpair": "en|{language}".format(language=language),
            "v": "1.0",
            "q": " .-. ".join(phrases)
        })
        ...
        # request base url
        request = urllib2.Request(base_url, data=urlencode(params), headers=HEADERS)
        # get response
        ...
        if (source["responseStatus"] == 200):
            return source["responseData"]["translatedText"].split(".-.")
